		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("altitude_kv.tester", "store_id", TEST_KV_ID),
					resource.TestCheckResourceAttr("altitude_kv.tester", "key", TEST_KV_KEY),
					resource.TestCheckResourceAttr("altitude_kv.tester", "value", "testValue"),
				),
			},
			{
				Config: testAccKVResourceConfig(TEST_KV_ID, TEST_KV_KEY, "testValue"),
